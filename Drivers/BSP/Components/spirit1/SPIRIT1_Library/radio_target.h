...
#define RadioSpiCSLow()       HAL_GPIO_WritePin(SPIRIT1_CSn_GPIO_Port, SPIRIT1_CSn_Pin, GPIO_PIN_RESET)
#define RadioSpiCSHigh()      HAL_GPIO_WritePin(SPIRIT1_CSn_GPIO_Port, SPIRIT1_CSn_Pin, GPIO_PIN_SET)
